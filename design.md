...
the assignmentID.  The startTime is the time at which the marking was started, once the marking starts, the assignment can no longer be edited.  The started value will be undefined until the marking starts.
