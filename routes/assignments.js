...
router.get("/", async function (req, res, next) {
  ...
  try {
    ...
    } else if (req.query.assignmentID !== undefined && req.query.workerID !== undefined) { // type checks not necessary
      res.status(400).json({message: "You can only select by assignmentID or ownerID"});
    } else {
